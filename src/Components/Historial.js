...
class Historial extends React.Component {
  ...
  componentDidMount(){
    let urlFacturas = baseUrl + apiFacturasUrl;
    ...
    .then(response => {
      ...
      this.state.Facturas.map(value =>{

        let totalfactura = value.totalFactura;

        this.DeudaTotal = parseFloat(this.DeudaTotal) + parseFloat(totalfactura)

        
      })

      console.log(this.DeudaTotal)
    })
  }
